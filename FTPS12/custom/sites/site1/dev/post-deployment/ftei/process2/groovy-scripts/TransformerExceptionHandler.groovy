...
if(payload == null) {
    ...
    /*if ((payload instanceof B2mmlMaterialInformation) || 
     (payload instanceof B2mmlProductDefinition) || (payload instanceof B2mmlProductionSchedule))
     {
     LOGGER.info(
     '\n\tTransformer exception caught, payload.class = ' + payload.class.name +
     ', payload = ' + payload);
     return ('Rockwell: Transformer exception caught, class = ' +
